...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($conn->connect_error) {
        ...
        $sql = "INSERT INTO semen2 (patient_name, uhid, ref_by, age, date, material, gender, details)
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            header("Location: pathology.php?table=semen2&success=$successMessage");
            exit();
        } else {
            $response['status'] = 'error';
            ...
            header("Location: pathology.php?table=semen2&error=$errorMessage");
            exit();
        }
...
// Output JSON response
    header('location: pathology.php?table=semen2');
    exit;
