...
<body>
   ...
   <h2><span class="unique-heading">Widal Test Report</span></h2>
    ...
    <div id="patientReports">
        ...
        if(isset($_GET['id'])) {
            ...
            $id = $_GET['id'];
            $sql = "SELECT * FROM widalTest WHERE id = $id";
            ...
            <td>
                <table>
                    <tr style="border-bottom: 1px solid black;">
                        <th width="33.33%" align="center">TEST PERFORMED</th>
                        <th width="33.33%" align="center">RESULT</th>
                        <th width="33.33%" align="center">NORMAL RANGE</th>
                    </tr>
                    <tr style="border-bottom: 1px solid black;">
                        <td width="33.33%" align="center">GLUCOSE F</td>
                        <td width="33.33%" align="center"> <?php echo $row['glucose_f'] ?></td>
                        <td width="33.33%" align="center"><span>60 - 120</span> (mg/dl)</td>
                    </tr>
                    
                    <tr style="border-bottom: 1px solid black;">
                        <td width="33.33%" align="center">GLUCOSE 2HR</td>
                        <td width="33.33%" align="center"> <?php echo $row['glucose_2hr'] ?></td>
                        <td width="33.33%" align="center"><span>70 - 140</span> (mg/dl)</td>
                    </tr>
                    <tr style="border-bottom: 1px solid black;">
                        <td width="33.33%" align="center">GLUCOSE RANDOM</td>
                        <td width="33.33%" align="center"> <?php echo $row['glucose_random'] ?></td>
                        <td width="33.33%" align="center"><span>60 - 140</span> (mg/dl)</td>
                    </tr>
                    
                    <tr >
                        <td width="33.33%" align="center">URIC ACID</td>
                        <td width="33.33%" align="center"> <?php echo $row['uric_acid'] ?></td>
                        <td width="33.33%" align="center"><span>3.2 - 7.4</span> (mg/dl)</td>
                    </tr>
