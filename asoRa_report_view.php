...
<body>
   ...
   <h2><span class="unique-heading">ASO/RA Report</span></h2>
    ...
    <div id="patientReports">
        ...
        if(isset($_GET['id'])) {
            ...
            $id = $_GET['id'];
            $sql = "SELECT * FROM asoRa WHERE id = $id";
          ...
          <tbody>
            ...
            <td>
                <table>
                    ...
                    <tr style="border-bottom: 1px solid black;">
                        <td width="33.33%" align="center">BLOOD SUGAR (F)</td>
                        <td width="33.33%" align="center"> <?php echo $row['bsugarf'] ?></td>
                        <td width="33.33%" align="center"><span>60 - 120</span> (mg/dl)</td>
                    </tr>
                    
                    <tr style="border-bottom: 1px solid black;">
                        <td width="33.33%" align="center">BLOOD SUGAR (R)</td>
                        <td width="33.33%" align="center"> <?php echo $row['bsugarr'] ?></td>
