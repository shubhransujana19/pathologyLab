...
<body>
    ...
    <h2><span class="unique-heading">STOOL Report</span></h2>
    ...
    <div id="patientReports">
        ...
        if(isset($_GET['id'])) {
            ...
            $id = $_GET['id'];
            $sql = "SELECT * FROM stool WHERE id = $id";
        ...
        <table border="1" id="table2" >
                <tbody>
                   ...
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">CONSISTENCY</td>
                        <td width="70%" align="center"><?php echo $row['consistency'] ?></td>
                    </tr>
                    <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">MUCUS</td>
                        <td width="70%" align="center"><?php echo $row['mucus'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">FRANK BLOOD</td>
                        <td width="70%" align="center"><?php echo $row['frank_blood'] ?></td>
                    </tr>
        </tbody>
        </table>
        ...
        <table border="1" id="table2">
            <tbody>
                    <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">REDUCING SUBSTANCES</td>
                        <td width="70%" align="center"> <?php echo $row['reducing_substances'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                   ...
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">PH</td>
                        <td width="70%" align="center"><?php echo $row['ph'] ?></td>
                    </tr>
        ...
        <table border="1" id="table2">
            <tbody>
                    <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">OVA </td>
                        <td width="70%" align="center"> <?php echo $row['ova'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">CYST</td>
                        <td width="70%" align="center"><?php echo $row['cyst'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">PROTOZOA</td>
                        <td width="70%" align="center"><?php echo $row['protozoa'] ?></td>
                    </tr>
                                       <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">VEGETABLE CELL</td>
                        <td width="70%" align="center"><?php echo $row['vegetable_cell'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">PUS CELL</td>
                        <td width="70%" align="center"><?php echo $row['pus_cell'] ?></td>
                    </tr>
                   ...
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">MICRO ORGANISM</td>
                        <td width="70%" align="center"><?php echo $row['micro_organism'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">STARCH</td>
                        <td width="70%" align="center"><?php echo $row['starch'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">FAT</td>
                        <td width="70%" align="center"><?php echo $row['fat'] ?></td>
                    </tr>
                   <tr style="border-bottom: 1px solid black;">
                        <td width="30%" align="left">OTHERS</td>
                        <td width="70%" align="center"><?php echo $row['others'] ?></td>
                    </tr>
